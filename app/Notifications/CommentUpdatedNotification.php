...
class CommentUpdatedNotification extends Notification {
	...
	public function toMail($notifiable) {
		...
		try {
			...
			// 		->cc($emails)
			// 		->subject('A Comment  Has Been Updated');
		...
		//       ->line('A Comment  Has Been Updated To Your Report By ' . $this->comment->commenter->name)
		...
		// ->line('Thank you for using our application!');
			...
			->line('A Comment  Has Been Updated In Your Report By ' . $this->comment->commenter->name)
			//->line(" at " . $this->comment->created_at)
			->line('Comment: ' . '"' . $this->comment->comment . '"')
			//->line('Kindly Click Here To View ')
