...
@section('content')
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Indicator Verification Status
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <div class="content-body">
        <h5>Indicator Verification Status Report</h5>

        <form action="{{route('report_generation.indicator_status_report')}}" method="get">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <div class="card">
