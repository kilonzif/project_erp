                                        ...
                                        <div data-repeater-item="" style="">
                                            <div class="row">
                                                ...
                                                <div class="form-group mb-1 col-md-4">
                                                    ...
                                                    <br>
                                                    <input type="text" required class="form-control" name="label" id="label" placeholder="Eg. Student Number">
                                                </div>
                                                ...
                                                <div class="form-group mb-1 col-md-3">
                                                    ...
                                                    <br>
                                                    <input type="text" placeholder="Eg. May, June, July" class="form-control select_options" name="select_options" id="select_options">
                                                </div>
