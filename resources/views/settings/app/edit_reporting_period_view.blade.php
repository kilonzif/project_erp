                    ...
                    <div class="card-content" style="">
                        <div class="card-body">
                            <div id="form_template">
                                <form action="{{route('settings.app_settings.update_reporting_period',[\Illuminate\Support\Facades\Crypt::encrypt($period->id)])}}" method="post">
                                    <div class="row">
                                        @csrf
                                        <div class="col-md-6">
                                            <label>Starting Period</label>
                                            <input type="month" id="period_start" name="period_start" min="1900-March"
                                                   max="today" class="form-control"   value="{{ (old('period_start')) ? old('period_start') : $period->period_start }}">
                                        </div>

                                        <div class="col-md-6">
                                            <label>End</label>
                                            <input type="month" id="period_start" name="period_end" min="1900-March"
                                                   class="form-control" value="{{ (old('period_end')) ? old('period_end') : $period->period_end }}" >
                                        </div>
                                    </div>
                                    <div class="row" style="padding-top: 20px;">
                                        <div class="col-md-6 offset-md-3" >
                                            <input type="submit" name="submit" value="Update Reporting Period" class="btn btn-primary mb-2">
                                        </div>
                                    </div>
                                </form>
                            </div>
