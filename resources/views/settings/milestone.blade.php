...
@section('content')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title mb-0">Milestone</h3>
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('home')}}">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{route("report_generation.verificationletter.list") }}">Milestone Log</a>
                        </li>
    ...
    <div class="content-body">
        <p class="text-left">
            <a href="{{route("report_generation.verificationletter.list") }}" class="btn  btn-secondary square"> Milestone Log List</a>
        </p>
        <div class="row">
            {{--<div class="col-md-3">--}}
                {{--<div class="card">--}}
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="{{route('report_generation.milestone.save')}}
                                            ...
                                            <div class="row">
                                                ...
                                                {{-- <div class="form-group mb-1 col-md-3">
                                                 ...
                                                 <div class="form-group mb-1 col-md-6">
                                                    <label for="">ACE Host University </label>
                                                    <br>
...
<div class="row">
                                                  ...
                                                  <div class="form-group mb-1 col-md-3">
                                                    ...
                                                    <br>
                                                    <input type="number" required class="form-control" name="milestone"  min="1" id="" placeholder=" " style="padding-left: 0.60rem;padding-right: 0.60rem;">

                                                    @if ($errors->has('milestone'))
                                                <p class="text-right">
                                                    <small class="warning text-muted">{{ $errors->first('milestone') }}</small>
                                                </p>
                                            @endif
                                                </div>
                                               ...
                                               <div class="form-group mb-1 col-md-3">
                                                <fieldset>
                                                    <label for="requested verification">Requested Verification</label>
                                                    <br>
                                                     <input type="date" class="form-control " id="date-mask" placeholder=" Date" name="requested verification" required
                                                />


                                                 @if ($errors->has('requested verification'))
                                                <p class="text-right">
                                                    <small class="warning text-muted">{{ $errors->first('requested verification') }}</small>
                                                </p>
                                            @endif
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="form-group mb-1 col-md-3">
                                                    <fieldset>
                                                    <label for="verification visit">Verification Visit</label>
                                                    <br>
                                                     <input type="date" class="form-control " id="date-mask" placeholder=" Date" name="verification visit" required
                                                />
                                                    @if ($errors->has('verification visit'))
                                                <p class="text-right">
                                                    <small class="warning text-muted">{{ $errors->first('verification visit') }}</small>
                                                </p>
                                            @endif
                                                    </fieldset>
                                                </div>
                                               ...
                                               <div class="form-group mb-1 col-md-3">
                                                <fieldset>
                                                    ...
                                                    <br>
                                                     <input type="date" class="form-control " id="date-mask" placeholder=" Date" name="visit report" required
                                                />


                                                 @if ($errors->has('visit report'))
                                                <p class="text-right">
                                                    <small class="warning text-muted">{{ $errors->first('visit report') }}</small>
                                                </p>
                                            @endif
                                                    </fieldset>
                                                </div>
...
<div class="form-group mb-1 col-md-6">
                                                    <label for="">Short Comings Rectified (if any)</label>
                                                    <br>
                                            ...
                                            @endif
                                                ...
                                                <div class="form-group mb-1 col-md-3">
                                                <fieldset>
                                                    <label for="">Verification Letter</label>
                                                    <br>
                                            ...
                                            @endif
                                                ...
                                                <div class="form-group mb-1 col-md-3">
                                                <fieldset>
                                                    <label for="">Disbursement Authorization </label>
                                                    <br>
                                                     <input type="date" class="form-control " id="date-mask" placeholder=" Date" name="letter_dated" required
                                                />
