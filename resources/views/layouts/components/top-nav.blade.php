...
{{--                        <img class="brand-logo" alt="stack admin logo" src="{{asset('images/aau_icon.png')}}">--}}
                        <h2 class="brand-text">AAU-MEL</h2>
                    </a>
                </li>
                <li class="nav-item d-none d-md-block nav-toggle"><a class="nav-link modern-nav-toggle pr-0" data-toggle="collapse"><i class="toggle-icon ft-toggle-right font-medium-3 blue-grey darken-3" data-ticon="ft-toggle-right"></i></a></li>
