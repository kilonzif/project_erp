                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12" >
                                <div id="form-card">
                                    @include('report-form.webforms.dlr_6_3_form')
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-content">
                    <div class="card-body table-responsive">
                        <table class="table table-striped table-bordered">
                            <tr>
                                <th style="min-width: 280px">{{$lang['Submission Date']}}</th>
                                <th style="min-width: 280px">{{$lang['Financial Report URL']}}</th>
                                <th style="min-width: 280px">{{$lang['Budget Report URL']}}</th>
                                <th style="min-width: 280px">{{$lang['Work Plan URL']}}</th>
                                <th style="min-width: 280px">{{$lang['Other Files URL']}}</th>
                            ...
                            @foreach($data as $datum)
                                <tr>
                                    ...
                                    <td>
                                        {{$datum->financial_report_url}}
                                    </td>
                                    <td>
                                    {{$datum->budget_report_url}}
                                    </td>
                                    <td>
                                        {{$datum->work_plan_url}}
                                    </td>
                                    <td>
                                        {{$datum->other_files_url}}
                                    </td>
                                    <td>
