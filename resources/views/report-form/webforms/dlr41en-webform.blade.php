                                            ...
                                            <div class="col-md-4">
                                                <fieldset class="form-group{{ $errors->has('level') ? ' form-control-warning' : '' }}">
                                                    ...
                                                    <select name="level" required class="form-control" id="language">
                                                        ...
                                                        <option {{(old('level')=='professional_course') ? "selected" :" "}} value="professional_course">Professional Short Course</option>
                                                    </select>
                                                    @if ($errors->has('level'))
                                                        <p class="text-right mb-0">
                                            ...
                                            <div class="col-md-4">
                                                <fieldset class="form-group{{ $errors->has('typeofaccreditation') ? ' form-control-warning' : '' }}">
                                                    ...
                                                    <select name="typeofaccreditation" required class="form-control" id="language">
                                                        <option value="">select one</option>
                                                        <option {{(old('typeofaccreditation')=='National') ? "selected" :" "}} value="National">National</option>
                                                        <option {{(old('typeofaccreditation')=='Regional') ? "selected" :" "}} value="Regional">Regional</option>
                                                        <option {{(old('typeofaccreditation')=='International') ? "selected" :" "}} value="International">International</option>
                                                        <option {{(old('typeofaccreditation')=='Gap Assessment') ? "selected" :" "}} value="Gap Assessment">Gap Assessment</option>
                                                        <option {{(old('typeofaccreditation')=='Self-Evaluation') ? "selected" :" "}} value="Self-Evaluation">Self-Evaluation</option>
                                                    </select>
                                                ...
                                                <fieldset class="form-group{{ $errors->has('exp_accreditationdate') ? ' form-control-warning' : '' }}">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" required name="exp_accreditationdate" class="form-control form-control datepicker"
                                                               data-date-format="D-M-YYYY" value="{{ (old('exp_accreditationdate')) ? old('exp_accreditationdate') : '' }}">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text" id="basic-addon4"><i class="fa fa-calendar"></i></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <fieldset class="form-group{{ $errors->has('newly_accredited_programme') ? ' form-control-warning' : '' }}">
                                                    ...
                                                    <div class="input-group">
                                                        <select name="newly_accredited_programme" class="form-control" required id="newly_accredited_programme">
                                                            <option value="">Select</option>
                                                            <option {{(old('newly_accredited_programme')=='No') ? "selected" :" "}} value="No">No</option>
                                                            <option {{(old('newly_accredited_programme')=='Yes') ? "selected" :" "}} value="Yes">Yes</option>
                                                        </select>
                                                    </div>
